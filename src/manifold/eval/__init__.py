...
that wires this to real checkpoints (issue #229: ``manifold-eval``, exporting the
after ckpt via the ADR-0006 bridge then driving both pipelines) lives in
``manifold.eval.cli``; the Artifact page builder (issue #230) is a local
presentation tool layered on the written JSON + PNGs.
"""
